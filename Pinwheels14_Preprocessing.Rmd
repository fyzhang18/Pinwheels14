...
poo <- subset(raw, TRIAL_INDEX < 49) #48 trials (3*16)
...
for (i in 204440:length(poo3$RECORDING_SESSION_LABEL)) {
...
write.csv(poo, "Pinwheel14_Infant_Preprocessed_AllSamples.csv", row.names=TRUE) #save to 
write.csv(poo3, "Pinwheel14_Infant_Preprocessed_RemovedTrackloss.csv", row.names=TRUE) #save to computer
```
...
write.csv(poo5, "Pinwheel14_Infant_Preprocessed_RemovedOutliers.csv", row.names=TRUE) #save to
```
